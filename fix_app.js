...
let targetStr = `const DEFAULT_SYSTEM_PROMPT =
...
let fixedStr = "const DEFAULT_SYSTEM_PROMPT = `\\n" + targetStr.split("\\n").join("\\n") + "`";
// Since it's huge, better to regex it out:
...
serverContent = serverContent.replace(/<project_instructions>[\s\S]*?jawab dengan bahasa indonesia\s*<system_prompt_dari_user> di atas.`;/, 
